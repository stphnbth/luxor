...
namespace Luxor.Encoding 
{
    public class Encoding 
    {
        ...
        public Encoding(string strEncoding, string confidence)
        {
            StrEncoding = strEncoding;
            Confidence = confidence;
        }

        protected string StrEncoding { get; set; }
        ...
        private string? prescanByteStream(byte[] bytes) 
        {
            // 1
        ...
        private void changeEncoding(string newEncoding) {  
            // 1
            if (StrEncoding.Equals("UTF-16BE/LE"))
            {
                Confidence = "certain";
                return;
            }
            ...
            // 2
            if (newEncoding.Equals("UTF-16BE/LE")) { StrEncoding = "UTF-8"; }

            // 3
            if (newEncoding.Equals("x-user-defined")) { StrEncoding = "windows-1252"; }

            // 4
            if (newEncoding.Equals(StrEncoding)) 
            {
                Confidence = "certain";
                return;
            }
